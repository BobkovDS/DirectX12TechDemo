...
void PSOSSAOLayer1::buildPSO(ID3D12Device* device, DXGI_FORMAT rtFormat, DXGI_FORMAT dsFormat)
{
	m_device = device;
	...
	D3D12_GRAPHICS_PIPELINE_STATE_DESC psoDescLayer1 = buildCommonPSODescription();
