...
DebugRender_View::DebugRender_View()
{
}
...
void DebugRender_View::initialize(const RenderMessager& renderParams)
{
	m_swapChain = renderParams.SwapChain;
	RenderBase::initialize(renderParams);
}

void DebugRender_View::build()
{
...
void DebugRender_View::draw(int flags)
{
...
void DebugRender_View::setSwapChainResources(ComPtr<ID3D12Resource>* swapChainResources)
{
	m_swapChainResources = swapChainResources;
}

void DebugRender_View::resize(UINT iwidth, UINT iheight)
{
...
void DebugRender_View::buildGeometry()
{
