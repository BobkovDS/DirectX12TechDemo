...
PSODebugLayer_Screen::PSODebugLayer_Screen()
{
}
...
void PSODebugLayer_Screen::buildShadersBlob()
{
	// Compile shaders and store it
	string basedir = "Shaders\\";
	string shaderName = "DebugScreenRender_shaders.hlsl";
...
void PSODebugLayer_Screen::buildPSO(ID3D12Device* device, DXGI_FORMAT rtFormat, DXGI_FORMAT dsFormat, DXGI_SAMPLE_DESC sampleDesc)
{
	m_device = device;
