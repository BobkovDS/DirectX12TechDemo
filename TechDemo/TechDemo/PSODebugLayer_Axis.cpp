...
PSODebugLayer_Axis::PSODebugLayer_Axis()
{
}
...
void PSODebugLayer_Axis::buildShadersBlob()
{
	// Compile shaders and store it
	string basedir = "Shaders\\";
	string shaderName = "DebugAxesRender_shaders.hlsl";
...
void PSODebugLayer_Axis::buildPSO(ID3D12Device* device, DXGI_FORMAT rtFormat, DXGI_FORMAT dsFormat, DXGI_SAMPLE_DESC sampleDesc)
{
	m_device = device;
