...
Texture2D gDiffuseMap[20] : register(t10); // Here is important that this value >= than number of SRV (t) in previous Technical Descriptor Heap, just mapping with rootsignature (here t10=t10) should be the same
