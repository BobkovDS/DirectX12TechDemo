...
PSODebugLayer_View::PSODebugLayer_View()
{
}
...
void PSODebugLayer_View::buildShadersBlob()
{
	// Compile shaders and store it
	string basedir = "Shaders\\";
	string shaderName = "DebugViewRender_shaders.hlsl";	
...
void PSODebugLayer_View::buildPSO(ID3D12Device* device, DXGI_FORMAT rtFormat, DXGI_FORMAT dsFormat)
{
	m_device = device;
